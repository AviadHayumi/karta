...
The write API changed after this guide was written. Use the [catalog](catalog/)
for current definitions and the [quickstart](examples/quickstart/) for SDK calls.
The old patch-list examples below do not work with this branch's CRD.
