...
// JobsetInitializing matches a JobSet bringing pods up, on the operator's own counters: some
// replicatedJob has active pods none of which are ready yet, and none have failed.
